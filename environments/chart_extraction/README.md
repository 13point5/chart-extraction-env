...
- **Source links**: `https://huggingface.co/datasets/13point5/line-ex`
...
| -------------- | ---- | -------- | ----------------------------------------------------------- |
| `split`        | str  | `"test"` | Hugging Face dataset split to load, usually `test` for eval or `train` for RL. |
| `num_examples` | int  | `-1`     | Optional env-side cap applied before dataset transformation |
